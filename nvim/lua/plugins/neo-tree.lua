    ...
    config = function()
      require("neo-tree").setup({
        ...
        filesystem = {
          ...
          use_trash = true, -- Activate trash (requires trash-cli)

          -- 2️⃣  **Tell Neo-tree which command to use**
          --     `trash` comes from trash-cli (brew install trash ; apt install trash-cli ; pipx …)
          trash = {
            cmd = "trash",    -- or "trash-put" if that’s what your distro installs
            require_confirm = true, -- ask <y/N> before moving to trash
          },
          filtered_items = {
