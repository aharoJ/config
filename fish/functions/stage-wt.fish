function stage-wt --description 'Create a stage git worktree with .env symlink and CC settings copy'
    set -l usage 'usage: stage-wt new <branch> [base] | stage-wt co <branch>'
    ...
    set -l wt "$HOME/.repository/stage-$safe_branch"
