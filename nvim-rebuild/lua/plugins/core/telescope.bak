...
return {
  ...
  opts = {
    defaults = {
      ...
      -- WHY these icons: Minimal, informative, not noisy.
      prompt_prefix = "   ",       -- Nerd Font search icon
      selection_caret = "  ",      -- Arrow for current selection
      entry_prefix = "   ",        -- Align unselected entries with caret
      multi_icon = " 󰄬 ",          -- Checkmark for multi-select
      ...
      mappings = {
        i = {
          ...
          ["<M-p>"] = require and "which_key" or "which_key",
