...
| --- | ---------------------- | ---------------------------------------------- | -------------------------------------------------------------- | --------- |
| 1   | **Karabiner-Elements** | The translator — keyboard firmware in software | HHKB remapping, Hyper key, layer logic                         | 🔴 Next   |
| 2   | **Neovim**             | The brain — editing, LSP, code intelligence    | Built first, everything else adapts to it                      | ⬜ Queued |
